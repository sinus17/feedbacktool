/*
  ...
  1. Changes
    - Add 'direct_upload' to platform check constraint in ad_creatives table
    - Create function to detect Supabase storage URLs
    - Add trigger to automatically set platform to 'direct_upload' for Supabase storage URLs
