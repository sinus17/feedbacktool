/*
  # Fix notes-only feedback submission
  
  1. Changes
    - Update the update_submission_status_on_message function to properly handle notes-only submissions
    - Ensure submission status is updated to 'feedback-needed' when artist submits notes without a video URL
