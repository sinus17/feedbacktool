/*
  # Fix WhatsApp Messaging with Group IDs
  
  1. Changes
    - Update the WhatsApp notification function to properly handle group IDs
    - Ensure proper formatting of group IDs for WhatsApp API
...
-- Update the log_whatsapp_notification_attempt function to handle group IDs properly
...
BEGIN
  ...
  -- Format the group ID
  formatted_group_id := format_whatsapp_group_id(artist_group_id);
