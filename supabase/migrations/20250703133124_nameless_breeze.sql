/*
  # Improve instant feedback display and status updates
  
  1. Changes
    - Update the update_submission_status_on_message function to ensure reliable status updates
    - Add detailed logging for better debugging
    - Ensure proper notification is sent when messages are added
