/*
  # Fix WhatsApp notification for ad creatives with null video name
  
  1. Changes
    - Update the log_whatsapp_notification_attempt function to handle null video names
    - Add fallback to "Untitled Video" when video_name is null
    - Improve logging of WhatsApp notification attempts
