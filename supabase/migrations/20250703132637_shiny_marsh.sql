/*
  ...
  1. Changes
    - Enhance the update_submission_status_on_message function to provide more detailed logging
    - Ensure the trigger reliably updates submission status when messages are added
    - Fix issue where artist has to refresh page to see status changes
...
BEGIN
  ...
  RAISE NOTICE 'Updated submission status: submission_id=%, affected_rows=%', 
